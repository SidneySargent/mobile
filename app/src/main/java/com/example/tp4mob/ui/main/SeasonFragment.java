...
import com.example.tp4mob.MainActivity;
...
public class SeasonFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(title.equals("Saisons")){
            ...
            ImageView imagePrintemps= (ImageView) view.findViewById(R.id.imageView1);
            ImageView imageAutomne= (ImageView) view.findViewById(R.id.imageView3);
            ImageView imageEte= (ImageView) view.findViewById(R.id.imageView2);
            ImageView imageHiver = (ImageView) view.findViewById(R.id.imageView4);
